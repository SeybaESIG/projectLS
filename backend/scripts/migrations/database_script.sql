...
--
-- Name: tb_achats; Type: TABLE; Schema: public; Owner: akslasj
--

CREATE TABLE public.tb_achats (
                                  id_util integer NOT NULL,
...
ALTER TABLE public.tb_achats OWNER TO akslasj;

--
-- Name: tb_achats_venteid_seq; Type: SEQUENCE; Schema: public; Owner: akslasj
--

ALTER TABLE public.tb_achats ALTER COLUMN venteid ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.tb_achats_venteid_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Data for Name: tb_achats; Type: TABLE DATA; Schema: public; Owner: akslasj
--

COPY public.tb_achats (id_util, id_annon, venteid, datevente) FROM stdin;
\.
...
--
-- Name: tb_achats_venteid_seq; Type: SEQUENCE SET; Schema: public; Owner: akslasj
--

SELECT pg_catalog.setval('public.tb_achats_venteid_seq', 1, false);
...
--
-- Name: tb_achats tb_achats_pkey; Type: CONSTRAINT; Schema: public; Owner: akslasj
--

ALTER TABLE ONLY public.tb_achats
    ADD CONSTRAINT tb_achats_pkey PRIMARY KEY (id_util, id_annon);
...
--
-- Name: tb_achats tb_achats_id_annon_fkey; Type: FK CONSTRAINT; Schema: public; Owner: akslasj
--

ALTER TABLE ONLY public.tb_achats
    ADD CONSTRAINT tb_achats_id_annon_fkey FOREIGN KEY (id_annon) REFERENCES public.tb_annonces(id_annon);


--
-- Name: tb_achats tb_achats_id_util_fkey; Type: FK CONSTRAINT; Schema: public; Owner: akslasj
--

ALTER TABLE ONLY public.tb_achats
    ADD CONSTRAINT tb_achats_id_util_fkey FOREIGN KEY (id_util) REFERENCES public.tb_utilisateurs(id_util);
